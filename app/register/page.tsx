            ...
            <div className="min-h-screen bg-[#fafafa] flex items-center justify-center px-4">
                <div className="w-full max-w-md text-center">
                    <div className="bg-white rounded-3xl shadow-xl border border-zinc-100 p-8">
                        ...
                        <h1 className="text-2xl font-black text-zinc-900 mb-2">¡Registro exitoso!</h1>
                        <p className="text-zinc-500 mb-6">
                            Revisa tu correo electrónico para confirmar tu cuenta.
                        </p>
                        <Link
                            href="/login"
                            className="inline-flex items-center gap-2 bg-emerald-600 text-white px-8 py-3 rounded-xl font-bold hover:bg-emerald-700 hover:scale-105 transition-all"
                        >
            ...
            <div className="w-full max-w-md">
                ...
                <div className="bg-white rounded-3xl shadow-xl border border-zinc-100 p-8">
                    <div className="text-center mb-8">
                        <h1 className="text-2xl font-black text-zinc-900 mb-2">Crea tu cuenta</h1>
                        <p className="text-zinc-500 text-sm">Únete a Contabio y automatiza tu trabajo</p>
                    </div>
                    ...
                    <form onSubmit={handleRegister} className="space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        onChange={handleChange}
                                        placeholder="••••••••"
                                        className="w-full pl-12 pr-11 py-3 border border-zinc-200 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-transparent outline-none transition-all"
                                        required
                                        minLength={8}
                                    />
                                    <button
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    onChange={handleChange}
                                    placeholder="••••••••"
                                    className="w-full px-4 py-3 border border-zinc-200 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-transparent outline-none transition-all"
                                    required
                                    minLength={8}
                                />
                            </div>
                        ...
                        <div className="text-xs text-zinc-500 space-y-1">
                            <div className={`flex items-center gap-2 ${formData.password.length >= 8 ? 'text-emerald-600' : ''}`}>
                                <div className={`w-2 h-2 rounded-full ${formData.password.length >= 8 ? 'bg-emerald-500' : 'bg-zinc-300'}`} />
                                Mínimo 8 caracteres
                            </div>
                            <div className={`flex items-center gap-2 ${/[A-Z]/.test(formData.password) ? 'text-emerald-600' : ''}`}>
                                <div className={`w-2 h-2 rounded-full ${/[A-Z]/.test(formData.password) ? 'bg-emerald-500' : 'bg-zinc-300'}`} />
                                Una mayúscula
                            </div>
                            <div className={`flex items-center gap-2 ${/[0-9]/.test(formData.password) ? 'text-emerald-600' : ''}`}>
                                <div className={`w-2 h-2 rounded-full ${/[0-9]/.test(formData.password) ? 'bg-emerald-500' : 'bg-zinc-300'}`} />
                                Un número
                            </div>
                        </div>
